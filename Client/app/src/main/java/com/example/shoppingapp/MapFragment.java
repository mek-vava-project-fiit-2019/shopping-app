...
import com.example.shoppingapp.controller.modelmanager.ShopManager;
...
import static com.example.shoppingapp.controller.Config.CONFIG_SHOPS_API_PATH;
...
public class MapFragment extends Fragment implements OnMapReadyCallback, LocationListener, IAsyncResult<Shop[]> {
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        if(mMap != null){
            ...
            HTTPGetRequestTask<Shop[]> getShopTask = new HTTPGetRequestTask(CONFIG_SERVER_PATH + "/" + CONFIG_SHOPS_API_PATH, Shop[].class,null);
    ...
    public void onLocationChanged(Location location) {
        ...
        String url =  CONFIG_SERVER_PATH + "/" + CONFIG_SHOPS_NEAREST_API_PATH;
